      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <div className="grid sm:grid-cols-[1fr_auto_1fr] gap-4 items-end">
            <div>
              <label className="text-sm font-bold text-[#002b5c] mb-2 block" htmlFor="from-length">From</label>
              <select
                id="from-length" value={fromUnit}
            ...
            <div>
              <label className="text-sm font-bold text-[#002b5c] mb-2 block" htmlFor="to-length">To</label>
              <select
                id="to-length" value={toUnit}
