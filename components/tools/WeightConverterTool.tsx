      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <div className="grid sm:grid-cols-[1fr_auto_1fr] gap-4 items-end">
            <div>
              <label className="text-sm font-bold text-[#002b5c] mb-2 block" htmlFor="from-weight">From</label>
              <select
                id="from-weight" value={fromUnit}
            ...
            <div>
              <label className="text-sm font-bold text-[#002b5c] mb-2 block" htmlFor="to-weight">To</label>
              <select
                id="to-weight" value={toUnit}
