...
const TITLE = "Random Number Generator (Free) — Any Range, Unique Option | Rajput Lalit & Associates";
const DESCRIPTION = "Free random number generator — generate one or many random numbers within any range, with an option to avoid duplicates. No sign-up needed.";

export const metadata: Metadata = {
  title: TITLE,
  description: DESCRIPTION,
  keywords: ["random number generator", "random number generator online free", "unique random number picker", "lucky draw number generator", "random number generator 1 to 100"],
  ...
  openGraph: {
    ...
    locale: "en_US",
    type: "website",
    images: [{ url: OG_IMAGE, width: 1200, height: 630, alt: "Random Number Generator — Rajput Lalit & Associates" }],
  },
  twitter: {
...
const faqs = [
  { question: "Can I generate multiple random numbers at once?", answer: "Yes — set \"How many numbers?\" to any value, and the tool generates that many random numbers within your chosen range in one click." },
  { question: "What does the \"no duplicates\" option do?", answer: "When enabled, every generated number is unique — no number repeats in the result. This is useful for lucky draws or sampling where each entry should only be picked once." },
  { question: "What's the maximum count I can generate with unique numbers?", answer: "The unique count is automatically capped at the total size of your chosen range — for example, you can't generate 200 unique numbers from a range of only 1 to 100." },
  { question: "Is this useful for business lucky draws or audit sampling?", answer: "Yes — businesses commonly use random number generators for contest draws, employee selection, or picking a random sample of invoices/transactions for an internal audit check." },
  { question: "Is this calculator free to use?", answer: "Yes, completely free with no sign-up or limits, for any range and count." }
];
  ...
  return (
    <>
      ...
      <main>
        <section className="relative overflow-hidden bg-gradient-to-br from-[#001d40] via-[#002b5c] to-[#06477f] text-white print:hidden">
          ...
          <div className="relative max-w-5xl mx-auto px-6 py-20 md:py-24 text-center">
            ...
            <h1 className="hero-in hero-in-2 mt-7 text-4xl md:text-6xl font-extrabold leading-tight">
              Random Number
              <span className="block text-[#f0b84b] mt-2">Generator</span>
            </h1>

            <p className="hero-in hero-in-3 mt-6 text-lg md:text-xl text-blue-100 leading-8 max-w-3xl mx-auto">
              Generate random numbers within any range — for draws, samples, games or passwords.
            </p>
        ...
        <div className="print:hidden">
          <Breadcrumb current="Random Number Generator" />
        </div>
