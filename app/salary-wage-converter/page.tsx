...
import WageConverterTool from "@/components/tools/WageConverterTool";

const SLUG = "salary-wage-converter";
const PAGE_URL = `https://www.rajputlalitassociates.in/${SLUG}`;
const OG_IMAGE = `/og/${SLUG}.png`;

const TITLE = "Salary / Wage Converter (Free) — Hourly to Annual & Back | Rajput Lalit & Associates";
const DESCRIPTION = "Free salary and wage converter — convert between hourly, daily, weekly, monthly and annual pay using your own work schedule. No sign-up needed.";

export const metadata: Metadata = {
  title: TITLE,
  description: DESCRIPTION,
  keywords: ["salary converter", "hourly to annual salary calculator", "wage converter online free", "salary to hourly rate calculator"],
  ...
  openGraph: {
    ...
    locale: "en_US",
    type: "website",
    images: [{ url: OG_IMAGE, width: 1200, height: 630, alt: "Salary / Wage Converter — Rajput Lalit & Associates" }],
  },
  twitter: {
...
const faqs = [
  { question: "How do I convert an hourly wage to an annual salary?", answer: "Annual salary = hourly rate x hours per day x days per week x weeks per year. With the common default (8 hours/day, 5 days/week, 52 weeks/year), a $25/hour wage works out to roughly $52,000/year." },
  { question: "Why does the calculator ask for my work schedule?", answer: "Because the conversion depends entirely on how many hours you actually work — someone working 6 hours/day or 4 days/week will have a different hourly-to-annual ratio than the standard full-time default." },
  { question: "Are these figures before or after tax?", answer: "Before tax (gross pay). This calculator doesn't account for income tax, social security or other deductions, which vary by country and individual circumstances." },
  { question: "Does this account for unpaid time off, like holidays or sick leave?", answer: "Only if you adjust \"weeks per year\" down to reflect actual paid working weeks. The default of 52 assumes continuous full-time work all year." },
  ...
  return (
    <>
      ...
      <main>
        <section className="relative overflow-hidden bg-gradient-to-br from-[#001d40] via-[#002b5c] to-[#06477f] text-white print:hidden">
          ...
          <div className="relative max-w-5xl mx-auto px-6 py-20 md:py-24 text-center">
            ...
            <p className="hero-in hero-in-3 mt-6 text-lg md:text-xl text-blue-100 leading-8 max-w-3xl mx-auto">
              Convert between hourly, daily, weekly, monthly and annual pay, worldwide.
            </p>
        ...
        <div className="print:hidden">
          <Breadcrumb current="Salary / Wage Converter" />
        </div>
