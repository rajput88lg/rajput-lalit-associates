...
import FractionDecimalConverterTool from "@/components/tools/FractionDecimalConverterTool";

const SLUG = "fraction-decimal-converter";
const PAGE_URL = `https://www.rajputlalitassociates.in/${SLUG}`;
const OG_IMAGE = `/og/${SLUG}.png`;

const TITLE = "Fraction to Decimal Converter (Free) — Both Ways | Rajput Lalit & Associates";
const DESCRIPTION = "Free fraction to decimal converter — convert any decimal into a simplified fraction, or any fraction into a decimal, instantly. No sign-up needed.";

export const metadata: Metadata = {
  title: TITLE,
  description: DESCRIPTION,
  keywords: ["fraction to decimal converter", "decimal to fraction calculator", "fraction calculator online free", "convert decimal to fraction", "simplify fraction calculator"],
  ...
  openGraph: {
    ...
    locale: "en_US",
    type: "website",
    images: [{ url: OG_IMAGE, width: 1200, height: 630, alt: "Fraction ⇄ Decimal Converter — Rajput Lalit & Associates" }],
  },
  twitter: {
...
const faqs = [
  { question: "How do I convert a decimal to a fraction?", answer: "Write the decimal as a fraction over a power of 10 (based on its number of decimal places), then simplify by dividing numerator and denominator by their greatest common divisor. For example, 0.75 = 75/100 = 3/4 after simplifying." },
  { question: "How do I convert a fraction to a decimal?", answer: "Simply divide the numerator by the denominator. For example, 3/4 = 0.75." },
  { question: "Does this calculator simplify fractions automatically?", answer: "Yes — the decimal-to-fraction result is always shown in its simplest (fully reduced) form." },
  { question: "Where is converting between fractions and decimals useful in finance?", answer: "Interest rates, ownership shares, tax rates and measurement units are sometimes expressed as fractions in older documents or contracts, and this tool makes quick, accurate conversion easy." },
  ...
  return (
    <>
      ...
      <main>
        ...
        <div className="print:hidden">
          <Breadcrumb current="Fraction ⇄ Decimal Converter" />
        </div>

        <FractionDecimalConverterTool />
