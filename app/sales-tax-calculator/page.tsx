...
import SalesTaxCalculatorTool from "@/components/tools/SalesTaxCalculatorTool";

const SLUG = "sales-tax-calculator";
const PAGE_URL = `https://www.rajputlalitassociates.in/${SLUG}`;
const OG_IMAGE = `/og/${SLUG}.png`;

const TITLE = "Sales Tax / VAT Calculator (Free) — Add or Remove Tax | Rajput Lalit & Associates";
const DESCRIPTION = "Free sales tax and VAT calculator — add tax to a price or work backwards from a tax-inclusive total, for any country's rate. Instant results, no sign-up.";

export const metadata: Metadata = {
  title: TITLE,
  description: DESCRIPTION,
  keywords: ["sales tax calculator", "vat calculator", "vat calculator online free", "add tax to price calculator", "reverse tax calculator"],
  ...
  openGraph: {
    ...
    locale: "en_US",
    type: "website",
    images: [{ url: OG_IMAGE, width: 1200, height: 630, alt: "Sales Tax / VAT Calculator — Rajput Lalit & Associates" }],
  },
  twitter: {
...
const faqs = [
  { question: "How do I add sales tax to a price?", answer: "Multiply the price by the tax rate and add it to the original price. For example, a $100 item with 10% sales tax = $100 + ($100 x 10%) = $110. This calculator does that instantly." },
  { question: "How do I find the price before tax from a tax-inclusive total?", answer: "Divide the total by (1 + tax rate). For example, a $110 total including 10% tax = $110 / 1.10 = $100 before tax. Use the \"Remove tax from a total\" mode above." },
  { question: "Does this work for VAT as well as sales tax?", answer: "Yes — the maths is identical whether you call it sales tax, VAT, or GST. Just enter the applicable percentage for your country or state." },
  { question: "Is this the same as India's GST calculator?", answer: "The maths is the same, but India's GST also splits the tax into CGST and SGST components. For that specific breakdown, use our dedicated GST Calculator instead." },
  { question: "Is this calculator free to use?", answer: "Yes, completely free with no sign-up or limits, and it works for any country's tax rate." }
];
  ...
  return (
    <>
      ...
      <main>
        <section className="relative overflow-hidden bg-gradient-to-br from-[#001d40] via-[#002b5c] to-[#06477f] text-white print:hidden">
          ...
          <div className="relative max-w-5xl mx-auto px-6 py-20 md:py-24 text-center">
            ...
            <h1 className="hero-in hero-in-2 mt-7 text-4xl md:text-6xl font-extrabold leading-tight">
              Sales Tax /
              <span className="block text-[#f0b84b] mt-2">VAT Calculator</span>
            </h1>
        ...
        <div className="print:hidden">
          <Breadcrumb current="Sales Tax / VAT Calculator" />
        </div>
