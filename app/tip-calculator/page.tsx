...
const TITLE = "Tip Calculator (2026) — Free Online Bill Tip & Split Calculator | Rajput Lalit & Associates";
const DESCRIPTION = "Free tip calculator — enter your bill amount, choose a tip percentage, and split the total among any number of people. Instant results with a per-person breakdown.";

export const metadata: Metadata = {
  title: TITLE,
  description: DESCRIPTION,
  keywords: ["tip calculator", "bill splitter", "tip calculator online free", "restaurant tip calculator", "split bill calculator"],
  ...
  openGraph: {
    ...
    locale: "en_US",
    type: "website",
    images: [{ url: OG_IMAGE, width: 1200, height: 630, alt: "Tip Calculator — Rajput Lalit & Associates" }],
  },
  twitter: {
...
const faqs = [
  { question: "How much should I tip?", answer: "Tipping norms vary widely by country and context — 10-20% of the bill is common in many places for restaurant service, but always check local custom, since some countries include service charges by default or don't expect tipping at all." },
  { question: "How is the per-person split calculated?", answer: "The total bill (including tip) is divided evenly by the number of people entered. For a more accurate split based on what each person actually ordered, you'd need to calculate individual shares of the bill separately before adding a proportional tip." },
  { question: "Can I enter a custom tip percentage?", answer: "Yes — use the preset buttons for common percentages (10%, 15%, 18%, 20%) or type any custom percentage into the field below them." },
  { question: "Does this calculator work for any currency?", answer: "Yes — the maths is the same regardless of currency; just read the result in whichever currency your bill is in." },
  { question: "Can I use this for group expense splitting beyond restaurants?", answer: "Yes — the same bill + tip/service-charge + people-splitting logic works for group taxi rides, shared accommodation charges, or any other expense you're dividing among a group." }
];
  ...
  return (
    <>
      ...
      <main>
        <section className="relative overflow-hidden bg-gradient-to-br from-[#001d40] via-[#002b5c] to-[#06477f] text-white print:hidden">
          ...
          <div className="relative max-w-5xl mx-auto px-6 py-20 md:py-24 text-center">
            ...
            <p className="hero-in hero-in-3 mt-6 text-lg md:text-xl text-blue-100 leading-8 max-w-3xl mx-auto">
              Work out the tip amount, total bill, and per-person split for any group size.
            </p>
        ...
        <div className="print:hidden">
          <Breadcrumb current="Tip Calculator" />
        </div>
