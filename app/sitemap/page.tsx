...
const sections = [
  {
    ...
    links: [
      ...
      { name: "Book Free Consultation", href: "/#appointment" },
      { name: "Talk to a Tax Expert (₹599 Call)", href: "/tax-consultation" },
      { name: "Website Project Discussion", href: "/appointment" },
      { name: "Fees", href: "/fees" },
      { name: "Blog", href: "/blog" },
    ],
  },
  {
    ...
    links: [
      ...
      { name: "GST Notice Reply", href: "/gst-notice-reply" },
      { name: "Income Tax Return Filing", href: "/income-tax-return-filing" },
      { name: "Accounting & Bookkeeping", href: "/accounting-bookkeeping-services" },
