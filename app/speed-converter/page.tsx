...
const TITLE = "Speed Converter (Free) — km/h to mph & More | Rajput Lalit & Associates";
const DESCRIPTION = "Free speed converter — convert between kilometres per hour, miles per hour, metres per second and knots instantly. No sign-up needed.";

export const metadata: Metadata = {
  title: TITLE,
  description: DESCRIPTION,
  keywords: ["speed converter", "km/h to mph converter", "mph to km/h", "speed conversion calculator online free", "knots to km/h"],
  ...
  openGraph: {
    ...
    locale: "en_US",
    type: "website",
    images: [{ url: OG_IMAGE, width: 1200, height: 630, alt: "Speed Converter — Rajput Lalit & Associates" }],
  },
  twitter: {
...
const faqs = [
  { question: "How do I convert km/h to mph?", answer: "Multiply km/h by 0.6214 to get mph. For example, 100 km/h is approximately 62.14 mph." },
  { question: "What is a knot in speed measurement?", answer: "A knot is a unit of speed used mainly in aviation and maritime navigation, equal to one nautical mile per hour — approximately 1.852 km/h." },
  { question: "How do I convert m/s to km/h?", answer: "Multiply m/s by 3.6 to get km/h. For example, 10 m/s is exactly 36 km/h." },
  { question: "Why would a business need a speed converter?", answer: "Logistics, transport, and travel businesses often need to reconcile speed limits or shipping speeds across countries using different unit systems." },
  { question: "Is this calculator free to use?", answer: "Yes, completely free with no sign-up or limits, and it works for any combination of speed units." }
];
  ...
  return (
    <>
      ...
      <main>
        <section className="relative overflow-hidden bg-gradient-to-br from-[#001d40] via-[#002b5c] to-[#06477f] text-white print:hidden">
          ...
          <div className="relative max-w-5xl mx-auto px-6 py-20 md:py-24 text-center">
            ...
            <p className="hero-in hero-in-3 mt-6 text-lg md:text-xl text-blue-100 leading-8 max-w-3xl mx-auto">
              Convert between km/h, mph, m/s and knots instantly.
            </p>
        ...
        <div className="print:hidden">
          <Breadcrumb current="Speed Converter" />
        </div>
