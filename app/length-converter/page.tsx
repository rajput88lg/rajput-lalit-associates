...
const TITLE = "Length Converter (2026) — Free Unit Converter (m, ft, cm, km, in) | Rajput Lalit & Associates";
const DESCRIPTION = "Free length unit converter — convert between millimetres, centimetres, metres, kilometres, inches, feet, yards and miles instantly, with all common conversions shown at once.";

export const metadata: Metadata = {
  title: TITLE,
  description: DESCRIPTION,
  keywords: ["length converter", "unit converter", "meters to feet converter", "cm to inches converter", "km to miles converter"],
  ...
  openGraph: {
    ...
    locale: "en_US",
    type: "website",
    images: [{ url: OG_IMAGE, width: 1200, height: 630, alt: "Length Converter — Rajput Lalit & Associates" }],
  },
  twitter: {
...
const faqs = [
  { question: "What length units does this converter support?", answer: "Millimetres, centimetres, metres, kilometres, inches, feet, yards and miles — covering the units most commonly needed for everyday, construction, property and travel-related conversions." },
  { question: "How accurate are the conversions?", answer: "Conversions use exact standard conversion factors (e.g. 1 inch = 2.54 cm exactly, 1 mile = 1,609.344 metres exactly), so results are precise to several decimal places." },
  { question: "Can I quickly swap the \"from\" and \"to\" units?", answer: "Yes — click the swap icon between the two unit dropdowns to instantly reverse the conversion direction." },
  { question: "Is this useful for property or land measurements?", answer: "For basic length conversions, yes. Indian property transactions often use additional units like square feet, square yards, acres, bighas or guntas for area (not length) — this tool handles length/distance units only." },
  { question: "Does this work on mobile?", answer: "Yes — the calculator is fully responsive and works on any phone, tablet or desktop browser." }
];
  ...
  return (
    <>
      ...
      <main>
        ...
        <div className="print:hidden">
          <Breadcrumb current="Length Converter" />
        </div>
