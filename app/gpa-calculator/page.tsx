...
const TITLE = "GPA Calculator (Free) — Calculate Your Weighted GPA | Rajput Lalit & Associates";
const DESCRIPTION = "Free GPA calculator — add each course's credit hours and letter grade to instantly calculate your weighted GPA on the standard US 4.0 scale. No sign-up needed.";

export const metadata: Metadata = {
  title: TITLE,
  description: DESCRIPTION,
  keywords: ["gpa calculator", "cgpa calculator", "college gpa calculator online free", "weighted gpa calculator", "semester gpa calculator"],
  ...
  openGraph: {
    ...
    locale: "en_US",
    type: "website",
    images: [{ url: OG_IMAGE, width: 1200, height: 630, alt: "GPA / CGPA Calculator — Rajput Lalit & Associates" }],
  },
  twitter: {
...
const faqs = [
  { question: "How is weighted GPA calculated?", answer: "GPA = total quality points divided by total credit hours, where each course's quality points equal its credit hours multiplied by its grade points (on a 4.0 scale). This gives more weight to higher-credit courses." },
  { question: "What grade point scale does this calculator use?", answer: "The standard US 4.0 scale, where A = 4.0, A- = 3.7, B+ = 3.3, B = 3.0, and so on down to F = 0.0. This is the most widely used scale internationally for GPA reporting." },
  { question: "Can I use this for a single semester or my overall cumulative GPA?", answer: "Both — add all courses from one semester for a semester GPA, or add every course you've taken for a cumulative GPA (CGPA)." },
  { question: "Why is my GPA useful for education loan or study-abroad planning?", answer: "Many education loan providers, universities and visa processes ask for your GPA or CGPA, and this calculator gives you an accurate, ready-to-quote figure." },
  { question: "Is this calculator free to use?", answer: "Yes, completely free with no sign-up or limits, for any number of courses." }
];
  ...
  return (
    <>
      ...
      <main>
        ...
        <div className="print:hidden">
          <Breadcrumb current="GPA / CGPA Calculator" />
        </div>
