...
const TITLE = "Break-Even Point Calculator (Free) — Units to Break Even | Rajput Lalit & Associates";
const DESCRIPTION = "Free break-even point calculator — enter fixed costs, variable cost per unit and selling price to find exactly how many units you need to sell to break even. No sign-up needed.";

export const metadata: Metadata = {
  title: TITLE,
  description: DESCRIPTION,
  keywords: ["break even calculator", "break even point calculator", "break even analysis calculator", "units to break even"],
  ...
  openGraph: {
    ...
    locale: "en_US",
    type: "website",
    images: [{ url: OG_IMAGE, width: 1200, height: 630, alt: "Break-Even Point Calculator — Rajput Lalit & Associates" }],
  },
  twitter: {
...
const faqs = [
  { question: "How is the break-even point calculated?", answer: "Break-even units = Fixed Costs / (Price per Unit - Variable Cost per Unit). The denominator is called the contribution margin per unit — the amount each sale contributes toward covering fixed costs." },
  { question: "What if my selling price is lower than my variable cost?", answer: "Then break-even is mathematically impossible at that price — every unit you sell loses money before fixed costs are even considered. You'd need to raise price or cut variable cost per unit." },
  { question: "What counts as a fixed cost vs a variable cost?", answer: "Fixed costs don't change with sales volume — rent, salaries, insurance. Variable costs scale with each unit sold — raw materials, packaging, per-unit shipping or commission." },
  { question: "Does this work for service businesses, not just products?", answer: "Yes — treat each billable hour, session or client as a \"unit\" with its own price and variable cost, and the same formula applies." },
  ...
  return (
    <>
      ...
      <main>
        ...
        <div className="print:hidden">
          <Breadcrumb current="Break-Even Point Calculator" />
        </div>
