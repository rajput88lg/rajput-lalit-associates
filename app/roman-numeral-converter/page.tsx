...
const TITLE = "Roman Numeral Converter (Free) — Number to Roman & Back | Rajput Lalit & Associates";
const DESCRIPTION = "Free Roman numeral converter — convert any number (1-3999) to Roman numerals, or convert a Roman numeral back to a regular number, instantly.";

export const metadata: Metadata = {
  title: TITLE,
  description: DESCRIPTION,
  keywords: ["roman numeral converter", "number to roman numerals", "roman numerals to number", "roman numeral calculator online free", "convert to roman numerals"],
  ...
  openGraph: {
    ...
    locale: "en_US",
    type: "website",
    images: [{ url: OG_IMAGE, width: 1200, height: 630, alt: "Roman Numeral Converter — Rajput Lalit & Associates" }],
  },
  twitter: {
...
const faqs = [
  { question: "What is the highest number this converter supports?", answer: "Standard Roman numerals (using single letters I, V, X, L, C, D, M) represent numbers from 1 to 3,999. Numbers outside that range aren't supported by the classical notation." },
  { question: "How do I convert a number to Roman numerals?", answer: "Enter the number in \"Number → Roman\" mode. For example, 1994 converts to MCMXCIV using the standard subtractive notation." },
  { question: "How do I convert a Roman numeral back to a number?", answer: "Switch to \"Roman → Number\" mode and type the Roman numeral, using only the letters I, V, X, L, C, D, M." },
  { question: "Where are Roman numerals commonly used today?", answer: "Clock faces, book chapter numbers, movie sequel titles, monarch and pope names (like Elizabeth II), and some legal or historical document numbering." },
  ...
  return (
    <>
      ...
      <main>
        ...
        <div className="print:hidden">
          <Breadcrumb current="Roman Numeral Converter" />
        </div>
