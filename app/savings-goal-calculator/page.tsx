...
import SavingsGoalCalculatorTool from "@/components/tools/SavingsGoalCalculatorTool";

const SLUG = "savings-goal-calculator";
const PAGE_URL = `https://www.rajputlalitassociates.in/${SLUG}`;
const OG_IMAGE = `/og/${SLUG}.png`;

const TITLE = "Savings Goal Calculator (Free) — Monthly Savings Needed | Rajput Lalit & Associates";
const DESCRIPTION = "Free savings goal calculator — enter your target amount, time frame and expected return to instantly see the monthly saving you need. No sign-up needed.";

export const metadata: Metadata = {
  title: TITLE,
  description: DESCRIPTION,
  keywords: ["savings goal calculator", "how much to save monthly calculator", "savings calculator online free", "monthly savings needed calculator"],
  ...
  openGraph: {
    ...
    locale: "en_US",
    type: "website",
    images: [{ url: OG_IMAGE, width: 1200, height: 630, alt: "Savings Goal Calculator — Rajput Lalit & Associates" }],
  },
  twitter: {
...
const faqs = [
  { question: "How does this calculator work out my required monthly saving?", answer: "It uses the future-value-of-annuity formula in reverse — given your target amount, time period and expected return, it solves for the constant monthly contribution needed to reach that target." },
  { question: "What if I don't earn any return on my savings?", answer: "With a 0% expected return, the calculator simply divides your target amount by the number of months — no growth assumption is applied." },
  { question: "Does a higher expected return really reduce how much I need to save?", answer: "Yes, meaningfully over longer time periods — investment growth does part of the work for you. But higher returns usually come with higher risk, so don't assume a rate you're not confident you can actually get." },
  { question: "Can I use this for any savings goal — house down payment, wedding, education?", answer: "Yes — the maths is the same for any lump-sum target amount, regardless of what you're saving for." },
  ...
  return (
    <>
      ...
      <main>
        <section className="relative overflow-hidden bg-gradient-to-br from-[#001d40] via-[#002b5c] to-[#06477f] text-white print:hidden">
          ...
          <div className="relative max-w-5xl mx-auto px-6 py-20 md:py-24 text-center">
            ...
            <p className="hero-in hero-in-3 mt-6 text-lg md:text-xl text-blue-100 leading-8 max-w-3xl mx-auto">
              Find out how much you need to save each month to hit a target amount.
            </p>
        ...
        <div className="print:hidden">
          <Breadcrumb current="Savings Goal Calculator" />
        </div>
