...
const TITLE = "Area Converter (Free) — Sq Ft to Sq M, Acre to Hectare | Rajput Lalit & Associates";
const DESCRIPTION = "Free area converter — convert between square feet, square metres, square yards, acres, hectares and square kilometres instantly. Useful for property and land measurements.";

export const metadata: Metadata = {
  title: TITLE,
  description: DESCRIPTION,
  keywords: ["area converter", "square feet to square meter", "acre to hectare converter", "sq ft to sq yard", "land area calculator online free"],
  ...
  openGraph: {
    ...
    locale: "en_US",
    type: "website",
    images: [{ url: OG_IMAGE, width: 1200, height: 630, alt: "Area Converter — Rajput Lalit & Associates" }],
  },
  twitter: {
...
const faqs = [
  { question: "How many square feet are in a square metre?", answer: "1 square metre equals approximately 10.764 square feet. So a 1,000 sq ft apartment is about 92.9 square metres." },
  { question: "How many square feet are in an acre?", answer: "1 acre equals 43,560 square feet, or about 4,046.86 square metres." },
  { question: "How do I convert acres to hectares?", answer: "Multiply acres by 0.4047 to get hectares. For example, 5 acres is approximately 2.02 hectares." },
  { question: "Why do property listings in India sometimes use different area units?", answer: "Units like sq ft, sq yard, acre and hectare are all commonly used across different Indian states and property types — this converter lets you compare them on a common basis before registration or purchase." },
  { question: "Is this calculator free to use?", answer: "Yes, completely free with no sign-up or limits, and it works for any combination of area units." }
];
  ...
  return (
    <>
      ...
      <main>
        <section className="relative overflow-hidden bg-gradient-to-br from-[#001d40] via-[#002b5c] to-[#06477f] text-white print:hidden">
          ...
          <div className="relative max-w-5xl mx-auto px-6 py-20 md:py-24 text-center">
            ...
            <p className="hero-in hero-in-3 mt-6 text-lg md:text-xl text-blue-100 leading-8 max-w-3xl mx-auto">
              Convert between square feet, square metres, acres, hectares, square yards and more.
            </p>
        ...
        <div className="print:hidden">
          <Breadcrumb current="Area Converter" />
        </div>
