...
const TITLE = "BMI Calculator (2026) — Free Body Mass Index Calculator | Rajput Lalit & Associates";
const DESCRIPTION = "Free BMI (Body Mass Index) calculator — enter your weight and height in metric or imperial units to instantly see your BMI and WHO weight category. No sign-up required.";

export const metadata: Metadata = {
  title: TITLE,
  description: DESCRIPTION,
  keywords: ["bmi calculator", "body mass index calculator", "bmi calculator free", "bmi calculator kg cm", "ideal weight calculator"],
  ...
  openGraph: {
    ...
    locale: "en_US",
    type: "website",
    images: [{ url: OG_IMAGE, width: 1200, height: 630, alt: "BMI Calculator — Rajput Lalit & Associates" }],
  },
  twitter: {
...
const faqs = [
  { question: "What is BMI and how is it calculated?", answer: "Body Mass Index (BMI) is calculated as weight in kilograms divided by height in metres squared (BMI = kg ÷ m²). It's a simple screening tool used worldwide to categorise weight ranges relative to height." },
  { question: "What are the standard BMI categories?", answer: "Per WHO guidelines for adults: below 18.5 is Underweight, 18.5–24.9 is Normal weight, 25.0–29.9 is Overweight, and 30.0 and above is Obese." },
  { question: "Is BMI accurate for everyone?", answer: "No — BMI does not distinguish muscle mass from fat mass, so it can overestimate body fat in athletes and underestimate it in older adults who've lost muscle. It's a general screening tool, not a diagnosis." },
  { question: "Can I use pounds and feet/inches instead of kg and cm?", answer: "Yes — toggle to \"Imperial (lb / ft-in)\" mode above and enter your weight in pounds and height in feet and inches." },
  { question: "Should I make health decisions based on BMI alone?", answer: "No — always consult a qualified healthcare professional for personal health advice. BMI is one general indicator among many and doesn't account for individual factors like body composition, age, or medical history." }
];
  ...
  return (
    <>
      ...
      <main>
        <section className="relative overflow-hidden bg-gradient-to-br from-[#001d40] via-[#002b5c] to-[#06477f] text-white print:hidden">
          ...
          <div className="relative max-w-5xl mx-auto px-6 py-20 md:py-24 text-center">
            ...
            <p className="hero-in hero-in-3 mt-6 text-lg md:text-xl text-blue-100 leading-8 max-w-3xl mx-auto">
              Calculate your Body Mass Index using the standard WHO formula — in metric (kg/cm) or imperial (lb/ft-in) units.
            </p>
        ...
        <div className="print:hidden">
          <Breadcrumb current="BMI Calculator" />
        </div>
