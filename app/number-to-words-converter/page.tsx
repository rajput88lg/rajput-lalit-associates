...
const SLUG = "number-to-words-converter";
const PAGE_URL = `https://www.rajputlalitassociates.in/${SLUG}`;
const OG_IMAGE = `/og/${SLUG}.png`;

const TITLE = "Number to Words Converter (Free) — Convert Numbers to English Words | Rajput Lalit & Associates";
const DESCRIPTION = "Free number to words converter — instantly convert any number into English words, useful for writing amounts on cheques, invoices and legal or financial documents.";

export const metadata: Metadata = {
  title: TITLE,
  description: DESCRIPTION,
  keywords: ["number to words converter", "number to words in english", "convert amount to words", "cheque amount in words calculator", "number to words online free"],
  ...
  openGraph: {
    ...
    locale: "en_US",
    type: "website",
    images: [{ url: OG_IMAGE, width: 1200, height: 630, alt: "Number to Words Converter — Rajput Lalit & Associates" }],
  },
  twitter: {
...
const faqs = [
  { question: "Why would I need to convert a number to words?", answer: "Cheques, invoices, legal contracts and some government forms require amounts to be written out in words as well as figures, to prevent tampering or misreading." },
  { question: "Does this use the international (thousand/million) system or the Indian (lakh/crore) system?", answer: "The words themselves use the international thousand/million/billion system, but the tool also shows the number formatted with Indian-style lakh/crore commas as a quick reference." },
  { question: "Can this convert decimal amounts?", answer: "This version converts whole numbers into words. For amounts with paise or cents, convert the whole-number part and add the fractional part separately, as is standard cheque-writing practice." },
  { question: "Is this useful for filling GST invoices or ITR-related documents?", answer: "Yes — many financial and legal documents in India require the total amount to be written in words alongside the figures, and this tool makes that quick and error-free." },
  { question: "Is this calculator free to use?", answer: "Yes, completely free with no sign-up or limits, for any number size." }
];
  ...
  return (
    <>
      ...
      <main>
        ...
        <div className="print:hidden">
          <Breadcrumb current="Number to Words Converter" />
        </div>
