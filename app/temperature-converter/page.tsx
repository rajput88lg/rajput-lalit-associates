...
const TITLE = "Temperature Converter (2026) — Celsius to Fahrenheit to Kelvin | Rajput Lalit & Associates";
const DESCRIPTION = "Free temperature converter — convert between Celsius, Fahrenheit and Kelvin instantly. Enter a value in any unit and see the equivalent in the other two immediately.";

export const metadata: Metadata = {
  title: TITLE,
  description: DESCRIPTION,
  keywords: ["temperature converter", "celsius to fahrenheit converter", "fahrenheit to celsius calculator", "kelvin converter", "celsius to kelvin"],
  ...
  openGraph: {
    ...
    locale: "en_US",
    type: "website",
    images: [{ url: OG_IMAGE, width: 1200, height: 630, alt: "Temperature Converter — Rajput Lalit & Associates" }],
  },
  twitter: {
...
const faqs = [
  { question: "What is the formula to convert Celsius to Fahrenheit?", answer: "°F = (°C × 9/5) + 32. For example, 100°C (boiling point of water) equals 212°F." },
  { question: "What is the formula to convert Fahrenheit to Celsius?", answer: "°C = (°F − 32) × 5/9. For example, 32°F (freezing point of water) equals 0°C." },
  { question: "What is Kelvin and how does it relate to Celsius?", answer: "Kelvin is the SI base unit of temperature, used mainly in science. K = °C + 273.15. Unlike Celsius and Fahrenheit, Kelvin has no negative values — 0 K is absolute zero." },
  { question: "Which temperature scale is used where?", answer: "Celsius is used in most of the world for everyday purposes. Fahrenheit is mainly used in the United States. Kelvin is used in scientific and engineering contexts worldwide." },
  { question: "Is this converter precise enough for scientific use?", answer: "Results are rounded to 2 decimal places, which is sufficient for everyday and educational use. For precision scientific work, use the exact formulas directly with your required decimal precision." }
];
  ...
  return (
    <>
      ...
      <main>
        ...
        <div className="print:hidden">
          <Breadcrumb current="Temperature Converter" />
        </div>
