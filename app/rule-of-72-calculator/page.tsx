...
import RuleOf72CalculatorTool from "@/components/tools/RuleOf72CalculatorTool";

const SLUG = "rule-of-72-calculator";
const PAGE_URL = `https://www.rajputlalitassociates.in/${SLUG}`;
const OG_IMAGE = `/og/${SLUG}.png`;

const TITLE = "Rule of 72 Calculator (Free) — Money Doubling Time | Rajput Lalit & Associates";
const DESCRIPTION = "Free Rule of 72 calculator — find out how many years it takes your money to double at a given interest rate, or the rate needed to double in a set number of years. No sign-up needed.";

export const metadata: Metadata = {
  title: TITLE,
  description: DESCRIPTION,
  keywords: ["rule of 72 calculator", "doubling time calculator", "how long to double my money calculator", "compound interest doubling time"],
  ...
  openGraph: {
    ...
    locale: "en_US",
    type: "website",
    images: [{ url: OG_IMAGE, width: 1200, height: 630, alt: "Rule of 72 Calculator — Rajput Lalit & Associates" }],
  },
  twitter: {
...
const faqs = [
  { question: "What is the Rule of 72?", answer: "It's a quick mental-math shortcut for estimating how many years it takes an investment to double at a given annual compound rate: Years to double is approximately 72 divided by the annual rate. For example, at 8% annual return, money roughly doubles in 72/8 = 9 years." },
  { question: "How accurate is the Rule of 72?", answer: "It's most accurate for annual rates roughly between 6% and 10%. Outside that range, the approximation gets less precise — for an exact answer at any rate, use a full compound interest calculator." },
  { question: "Can I use the Rule of 72 to find the rate I need instead of the years?", answer: "Yes — rearrange it: Rate needed is approximately 72 divided by the number of years. This calculator supports both directions." },
  { question: "Does the Rule of 72 work for debt as well as investments?", answer: "Yes — it works for any situation involving compound growth at a fixed rate, including how quickly debt at a given interest rate would double if left unpaid." },
  { question: "Is this calculator free to use?", answer: "Yes, completely free with no sign-up or limits, and it works for any currency or rate." }
];
  ...
  return (
    <>
      ...
      <main>
        ...
        <div className="print:hidden">
          <Breadcrumb current="Rule of 72 Calculator" />
        </div>
