...
const TITLE = "Profit Margin Calculator (Free) — Gross Profit Margin | Rajput Lalit & Associates";
const DESCRIPTION = "Free profit margin calculator — enter revenue and cost to instantly find your gross profit, profit margin % and equivalent markup %. No sign-up needed.";

export const metadata: Metadata = {
  title: TITLE,
  description: DESCRIPTION,
  keywords: ["profit margin calculator", "gross profit margin calculator", "profit margin calculator online free", "margin calculator"],
  ...
  openGraph: {
    ...
    locale: "en_US",
    type: "website",
    images: [{ url: OG_IMAGE, width: 1200, height: 630, alt: "Profit Margin Calculator — Rajput Lalit & Associates" }],
  },
  twitter: {
...
const faqs = [
  { question: "How is profit margin calculated?", answer: "Profit margin % = (Revenue - Cost) / Revenue x 100. For example, $100 revenue and $80 cost gives a $20 profit, which is a 20% profit margin." },
  { question: "What's a good profit margin?", answer: "It varies hugely by industry — retail and grocery often run 2-5% net margins, while software and services can run 60-80%+ gross margins. Compare your margin to others in your specific industry, not a generic benchmark." },
  { question: "Is this gross margin or net margin?", answer: "This calculates gross profit margin — revenue minus your direct cost of goods/services. Net margin would also subtract operating expenses, taxes and interest, which this simple calculator doesn't account for." },
  { question: "How is markup % different from margin % here?", answer: "Markup % is the same profit expressed as a percentage of cost instead of revenue — this calculator shows both so you can see the difference." },
  ...
  return (
    <>
      ...
      <main>
        <section className="relative overflow-hidden bg-gradient-to-br from-[#001d40] via-[#002b5c] to-[#06477f] text-white print:hidden">
          ...
          <div className="relative max-w-5xl mx-auto px-6 py-20 md:py-24 text-center">
            ...
            <p className="hero-in hero-in-3 mt-6 text-lg md:text-xl text-blue-100 leading-8 max-w-3xl mx-auto">
              Find your gross profit margin from revenue and cost, instantly.
            </p>
        ...
        <div className="print:hidden">
          <Breadcrumb current="Profit Margin Calculator" />
        </div>
