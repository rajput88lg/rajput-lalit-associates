...
const TITLE = "Simple Interest Calculator (2026) — Free Online SI Calculator | Rajput Lalit & Associates";
const DESCRIPTION = "Free simple interest calculator — enter principal, annual interest rate and time period to instantly see the interest earned and total amount payable, using the standard simple interest formula.";

export const metadata: Metadata = {
  title: TITLE,
  description: DESCRIPTION,
  keywords: ["simple interest calculator", "simple interest formula calculator", "SI calculator online", "interest calculator free"],
  ...
  openGraph: {
    ...
    locale: "en_US",
    type: "website",
    images: [{ url: OG_IMAGE, width: 1200, height: 630, alt: "Simple Interest Calculator — Rajput Lalit & Associates" }],
  },
  twitter: {
...
const faqs = [
  { question: "What is the simple interest formula?", answer: "Simple Interest = (Principal × Rate × Time) ÷ 100, where Rate is the annual interest rate as a percentage and Time is in years. The total amount payable is Principal + Simple Interest." },
  { question: "What's the difference between simple interest and compound interest?", answer: "Simple interest is calculated only on the original principal for the entire period. Compound interest is calculated on the principal plus any interest already accumulated, so it grows faster over time. Most bank loans and deposits today use compound/reducing-balance methods, not simple interest." },
  { question: "Where is simple interest actually used?", answer: "It's used for some short-term loans, certain fixed-term instruments, and is commonly taught as the foundational interest concept before compound interest. Always check which method a specific lender or scheme actually uses." },
  { question: "Can I use a fractional time period like 1.5 years?", answer: "Yes — the time field accepts decimal values, so you can enter 1.5 years, 2.25 years, or any other fractional period." },
  { question: "Does this calculator apply to Indian tax-saving instruments?", answer: "Some traditional instruments do use simple-interest-like structures, but many modern ones (PPF, bank FDs, etc.) use compound interest — check our Compound Interest Calculator for those, or talk to us about which applies to your specific investment." }
];
  ...
  return (
    <>
      ...
      <main>
        ...
        <div className="print:hidden">
          <Breadcrumb current="Simple Interest Calculator" />
        </div>
