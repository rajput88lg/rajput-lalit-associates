...
const TITLE = "Markup Calculator (Free) — Cost Price to Selling Price | Rajput Lalit & Associates";
const DESCRIPTION = "Free markup calculator — enter your cost price and desired markup % to instantly get your selling price, gross profit and profit margin. No sign-up needed.";

export const metadata: Metadata = {
  title: TITLE,
  description: DESCRIPTION,
  keywords: ["markup calculator", "markup calculator online free", "cost to selling price calculator", "markup vs margin calculator"],
  ...
  openGraph: {
    ...
    locale: "en_US",
    type: "website",
    images: [{ url: OG_IMAGE, width: 1200, height: 630, alt: "Markup Calculator — Rajput Lalit & Associates" }],
  },
  twitter: {
...
const faqs = [
  { question: "How do I calculate selling price from cost and markup %?", answer: "Selling price = cost x (1 + markup% / 100). For example, a $80 cost with a 25% markup = $80 x 1.25 = $100 selling price." },
  { question: "What's the difference between markup and margin?", answer: "Markup is profit as a percentage of cost price; margin is profit as a percentage of selling price. A 25% markup on $80 cost gives a $100 selling price, but that's only a 20% profit margin — the two numbers are never equal above 0%." },
  { question: "Why does my margin % look lower than my markup %?", answer: "Because margin is calculated on the larger number (selling price) while markup is calculated on the smaller number (cost price) — the same dollar profit is always a smaller percentage of a bigger base." },
  { question: "Can I use this for services, not just products?", answer: "Yes — the same maths applies whether \"cost\" is your cost of goods, or your cost of delivering a service (time, materials, overheads)." },
  ...
  return (
    <>
      ...
      <main>
        <section className="relative overflow-hidden bg-gradient-to-br from-[#001d40] via-[#002b5c] to-[#06477f] text-white print:hidden">
          ...
          <div className="relative max-w-5xl mx-auto px-6 py-20 md:py-24 text-center">
            ...
            <p className="hero-in hero-in-3 mt-6 text-lg md:text-xl text-blue-100 leading-8 max-w-3xl mx-auto">
              Work out your selling price from cost price and desired markup percentage.
            </p>
        ...
        <div className="print:hidden">
          <Breadcrumb current="Markup Calculator" />
        </div>
