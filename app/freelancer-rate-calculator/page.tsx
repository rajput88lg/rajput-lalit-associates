...
import FreelancerRateCalculatorTool from "@/components/tools/FreelancerRateCalculatorTool";

const SLUG = "freelancer-rate-calculator";
const PAGE_URL = `https://www.rajputlalitassociates.in/${SLUG}`;
const OG_IMAGE = `/og/${SLUG}.png`;

const TITLE = "Freelancer Hourly Rate Calculator (Free) — What to Charge | Rajput Lalit & Associates";
const DESCRIPTION = "Free freelancer hourly rate calculator — enter your target income, expenses and billable hours to find exactly what rate to charge clients. No sign-up needed.";

export const metadata: Metadata = {
  title: TITLE,
  description: DESCRIPTION,
  keywords: ["freelancer rate calculator", "hourly rate calculator for freelancers", "what should I charge calculator", "freelance pricing calculator"],
  ...
  openGraph: {
    ...
    locale: "en_US",
    type: "website",
    images: [{ url: OG_IMAGE, width: 1200, height: 630, alt: "Freelancer Hourly Rate Calculator — Rajput Lalit & Associates" }],
  },
  twitter: {
...
const faqs = [
  { question: "How do I work out what hourly rate to charge as a freelancer?", answer: "Add your target take-home income and annual business expenses together, then divide by your total billable hours per year (billable hours per week x working weeks per year). That gives the rate you need to charge, on average, to hit your target." },
  { question: "Why is billable hours per week usually much lower than total working hours?", answer: "Because time spent on admin, marketing, client acquisition, invoicing and unpaid pitches doesn't generate revenue. Most freelancers can only bill 50-70% of their total working hours — plan your rate around billable hours, not total hours worked." },
  { question: "Does this rate include taxes?", answer: "No — this calculates the rate needed to cover your target take-home income plus business expenses. You'll still need to set aside money separately for income tax and, where applicable, GST or self-employment tax." },
  { question: "Should I charge exactly this calculated rate?", answer: "Treat it as a floor, not a target — it's the minimum needed to hit your income goal at 100% utilization. Building in a buffer for slow months, taxes and unexpected non-billable time is usually wise." },
  { question: "Is this calculator free to use?", answer: "Yes, completely free with no sign-up or limits, and it works in any currency." }
];
  ...
  return (
    <>
      ...
      <main>
        <section className="relative overflow-hidden bg-gradient-to-br from-[#001d40] via-[#002b5c] to-[#06477f] text-white print:hidden">
          ...
          <div className="relative max-w-5xl mx-auto px-6 py-20 md:py-24 text-center">
            ...
            <p className="hero-in hero-in-3 mt-6 text-lg md:text-xl text-blue-100 leading-8 max-w-3xl mx-auto">
              Work out the hourly rate you need to charge to hit your target income.
            </p>
        ...
        <div className="print:hidden">
          <Breadcrumb current="Freelancer Hourly Rate Calculator" />
        </div>

        <FreelancerRateCalculatorTool />
