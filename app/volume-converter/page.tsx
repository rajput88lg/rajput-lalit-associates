...
const TITLE = "Volume Converter (Free) — Litres to Gallons & More | Rajput Lalit & Associates";
const DESCRIPTION = "Free volume converter — convert between litres, millilitres, US gallons, cups, fluid ounces and imperial gallons instantly. No sign-up needed.";

export const metadata: Metadata = {
  title: TITLE,
  description: DESCRIPTION,
  keywords: ["volume converter", "litre to gallon converter", "ml to litre", "volume conversion calculator online free", "gallon to litre"],
  ...
  openGraph: {
    ...
    locale: "en_US",
    type: "website",
    images: [{ url: OG_IMAGE, width: 1200, height: 630, alt: "Volume Converter — Rajput Lalit & Associates" }],
  },
  twitter: {
...
const faqs = [
  { question: "How many litres are in a US gallon?", answer: "1 US gallon equals approximately 3.785 litres. So 10 US gallons is about 37.85 litres." },
  { question: "How is a US gallon different from an imperial (UK) gallon?", answer: "A US gallon (3.785 L) is smaller than an imperial gallon (4.546 L) — this calculator supports both, so make sure to pick the right one for your country." },
  { question: "How many millilitres are in a cup?", answer: "1 US cup equals approximately 236.59 millilitres." },
  { question: "Is this useful for business inventory or import/export documentation?", answer: "Yes — many international invoices and shipping documents use litres or gallons interchangeably, and this converter helps you reconcile them quickly." },
  { question: "Is this calculator free to use?", answer: "Yes, completely free with no sign-up or limits, and it works for any combination of volume units." }
];
  ...
  return (
    <>
      ...
      <main>
        <section className="relative overflow-hidden bg-gradient-to-br from-[#001d40] via-[#002b5c] to-[#06477f] text-white print:hidden">
          ...
          <div className="relative max-w-5xl mx-auto px-6 py-20 md:py-24 text-center">
            ...
            <p className="hero-in hero-in-3 mt-6 text-lg md:text-xl text-blue-100 leading-8 max-w-3xl mx-auto">
              Convert between litres, millilitres, gallons, cups and fluid ounces instantly.
            </p>
        ...
        <div className="print:hidden">
          <Breadcrumb current="Volume Converter" />
        </div>
